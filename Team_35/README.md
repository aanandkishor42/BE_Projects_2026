...
To design a hybrid CNN–Transformer architecture for robust temporal modeling

To convert recognized ISL gestures into grammatically correct English sentences

To support reverse translation (Text → ISL) using gloss mapping and animation synthesis
